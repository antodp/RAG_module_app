...
def get_chroma_db():
    ...
    if not CHROMA_DB_INSTANCE:
        ...
        # hack needed for AWS Lambda's base Python image (to work with an update version of SQLite)
        # in Lambda runtime, we ened to copy ChromaDB to /tmp so it can have write permissions
